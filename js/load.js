                ...
                setTimeout(() => {
                    ...
                    if(data["type"] == 2){
                        ...
                        if(data["phone"]==null){
                            ...
                            let _phone_a = data["phone"].slice(0,3);
                            let _phone_b = data["phone"].slice(3,7);
                            let _phone_c = data["phone"].slice(7,11);
                            $(".phone span",_company_user_message).text(_phone_a+"-"+_phone_b+"-"+_phone_c);
                            
                            //データ修正
                            $(".mypageCompany__messageFix .phone .sosmall:nth-of-type(1)").val(_phone_a);
                            $(".mypageCompany__messageFix .phone .sosmall:nth-of-type(2)").val(_phone_b);
                            $(".mypageCompany__messageFix .phone .sosmall:nth-of-type(3)").val(_phone_c);
                        }
